...
class Updated(models.Model):
    date_update = models.DateTimeField(verbose_name=_("Last Updated"), auto_now=True)
...
class Question(Updated):
    ...
    quiz = models.ForeignKey(Quizess, related_name='question', on_delete=models.DO_NOTHING())
